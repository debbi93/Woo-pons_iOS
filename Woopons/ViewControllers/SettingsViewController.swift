...
class SettingsViewController: UIViewController {
    ...
    var imagesArr = ["profile","password","feedback","terms","privacy","logout"]
    var namesArr = ["Profile","Change Password","Feedback & Suggestions","Terms & Conditions","Privacy policy","Log out"]
