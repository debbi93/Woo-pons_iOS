...
extension UIColor {
    ...
    @nonobjc class var textColor: UIColor {
        return UIColor(red: 64 / 255.0, green: 64 / 255.0, blue: 65, alpha: 1)
    }
...
extension UIButton {
    func underline(color:String) {
        guard let text = self.titleLabel?.text else { return }
        let attributedString = NSMutableAttributedString(string: text)
        //NSAttributedStringKey.foregroundColor : UIColor.blue
        attributedString.addAttribute(NSAttributedString.Key.underlineColor, value: UIColor(named: color)!, range: NSRange(location: 0, length: text.count))
        attributedString.addAttribute(NSAttributedString.Key.foregroundColor, value: UIColor(named: color)!, range: NSRange(location: 0, length: text.count))
    ...
    func applyButtonGradient() {
        ...
        let color0 = UIColor(named: "gradient1")!.cgColor
        let color1 = UIColor(named: "gradient2")!.cgColor
        let color2 = UIColor(named: "gradient3")!.cgColor
        let color3 = UIColor(named: "gradient4")!.cgColor
        gradientLayer.colors = [color3,color2,color1,color0]
        ...
        self.titleLabel?.font = UIFont.init(name: "Poppins-SemiBold", size: 16.0)
...
extension UIView {
    ...
    func applyViewGradient() {
        ...
        self.layoutIfNeeded()
        let gradientLayer = CAGradientLayer()
        let color0 = UIColor(named: "grayTextField")!.cgColor
        let color1 = UIColor.white.cgColor
        
        gradientLayer.colors = [color1,color0]
        gradientLayer.startPoint = CGPoint(x: 0, y: 0)
        gradientLayer.endPoint = CGPoint(x: 1, y: 0)
        gradientLayer.frame = self.bounds
        gradientLayer.cornerRadius = self.frame.height/2
    ...
    func addGradientWithColor(color: UIColor,color2:UIColor) {
        ...
        gradient.colors = [color2.cgColor, color.cgColor]
        self.layer.insertSublayer(gradient, at: 0)
    }
    
    func applyViewGradient1() {
        self.backgroundColor = nil
        self.layoutIfNeeded()
        let gradientLayer = CAGradientLayer()
        let color0 = UIColor(named: "gradient1")!.cgColor
...
extension UIViewController {
    ...
    func pushToPager1(){
        ...
        if let viewController = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "Pager1ViewController") as? Pager1ViewController {
    ...
    func pushToPager2(){
        ...
        if let viewController = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "Pager2ViewController") as? Pager2ViewController {
            if let navigator = navigationController {
                navigator.pushViewController(viewController, animated: true)
            }
        }
    ...
    func pushToPager3(){
        ...
        if let viewController = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "Pager3ViewController") as? Pager3ViewController {
            if let navigator = navigationController {
                navigator.pushViewController(viewController, animated: true)
            }
        }
    ...
    func pushToForgotPassword(){
        ...
        if let viewController = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "ForgotPasswordViewController") as? ForgotPasswordViewController {
            if let navigator = navigationController {
                navigator.pushViewController(viewController, animated: true)
            }
        }
    ...
    func pushToEnterCode(){
        
        if let viewController = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "CodeViewController") as? CodeViewController {
            if let navigator = navigationController {
                navigator.pushViewController(viewController, animated: true)
            }
        }
    ...
    func pushToTabBar(){
        ...
        if let viewController = UIStoryboard(name: "Home", bundle: nil).instantiateViewController(withIdentifier: "TabbarViewController") as? TabbarViewController {
            if let navigator = navigationController {
                navigator.pushViewController(viewController, animated: true)
            }
        }
    ...
    func pushToWebView(title:String,url:String){
        
        if let viewController = UIStoryboard(name: "Home", bundle: nil).instantiateViewController(withIdentifier: "PrivacyTermsViewController") as? PrivacyTermsViewController {
            if let navigator = navigationController {
    ...
    func pushToFeedback(){
        ...
        if let viewController = UIStoryboard(name: "Home", bundle: nil).instantiateViewController(withIdentifier: "FeedbackViewController") as? FeedbackViewController {
            if let navigator = navigationController {
                navigator.pushViewController(viewController, animated: true)
            }
        }
    ...
    func pushToProfile(){
        ...
        if let viewController = UIStoryboard(name: "Home", bundle: nil).instantiateViewController(withIdentifier: "ProfileViewController") as? ProfileViewController {
            if let navigator = navigationController {
                navigator.pushViewController(viewController, animated: true)
            }
        }
    ...
    func pushToFavorites(pageTitle:String,urlString:String){
        
        if let viewController = UIStoryboard(name: "Home", bundle: nil).instantiateViewController(withIdentifier: "FavoritesViewController") as? FavoritesViewController {
            if let navigator = navigationController {
    ...
    func pushToCategories(){
        
        if let viewController = UIStoryboard(name: "Home", bundle: nil).instantiateViewController(withIdentifier: "CategoriesViewController") as? CategoriesViewController {
            if let navigator = navigationController {
                navigator.pushViewController(viewController, animated: true)
            }
        }
    ...
    func pushToTopBrands(){
        
        if let viewController = UIStoryboard(name: "Home", bundle: nil).instantiateViewController(withIdentifier: "TopBrandsViewController") as? TopBrandsViewController {
            if let navigator = navigationController {
                navigator.pushViewController(viewController, animated: true)
            }
        }
    ...
    func pushToRecentlyAdded(){
        
        if let viewController = UIStoryboard(name: "Home", bundle: nil).instantiateViewController(withIdentifier: "RecentlyAddedViewController") as? RecentlyAddedViewController {
            if let navigator = navigationController {
                navigator.pushViewController(viewController, animated: true)
            }
        }
    ...
    func pushToTrendingCategories(){
        
        if let viewController = UIStoryboard(name: "Home", bundle: nil).instantiateViewController(withIdentifier: "TrendingCategoryViewController") as? TrendingCategoryViewController {
            if let navigator = navigationController {
                navigator.pushViewController(viewController, animated: true)
            }
        }
...
//    }
    ...
    //MARK: Save User Phone
    func setPhone(value: String){
        set(value, forKey: UserDefaultsKeys.phone.rawValue)
        //synchronize()
    }
    
    //MARK: Retrieve User Phone
    func getPhone() -> String{
        return string(forKey: UserDefaultsKeys.phone.rawValue) ?? ""
    }
    
    //MARK: Save Device IMEI
    func setDeviceId(value: String){
        set(value, forKey: UserDefaultsKeys.deviceId.rawValue)
        //synchronize()
    }
    
    //MARK: Retrieve Device IMEI
    func getDeviceId() -> String{
        return string(forKey: UserDefaultsKeys.deviceId.rawValue) ?? ""
    }
    
    
    //MARK: Save Profile Name
    func setProfileName(value: String){
        set(value, forKey: UserDefaultsKeys.profileName.rawValue)
        //synchronize()
    }
    
    //MARK: Retrieve Profile Name
    func getProfileName() -> String{
        return string(forKey: UserDefaultsKeys.profileName.rawValue) ?? ""
    }
    ...
    //MARK: Retrieve Gender
    func getGender() -> String{
        return string(forKey: UserDefaultsKeys.gender.rawValue) ?? ""
    }
    ...
    //MARK: Save Special Need
    func setSpecialNeed(value: Bool){
        set(value, forKey: UserDefaultsKeys.specialNeed.rawValue)
        //synchronize()
    }
    
    //MARK: Retrieve Special Need
    func getSpecialNeed() -> Bool{
        return bool(forKey: UserDefaultsKeys.specialNeed.rawValue)
    }
